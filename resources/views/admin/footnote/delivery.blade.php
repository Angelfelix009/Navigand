    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Update Delivery Information</li>
            </ol>
        </section>
        <section class="content">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div>
                        <form action="{{route('update-delivery-info',$data->id)}}" method="post" enctype="multipart/form-data">
                            @include('inc._message')
                            @csrf
                            <div class="form-group">
                                <label>Delivery Information Content</label>
