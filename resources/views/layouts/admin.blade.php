...
<head>
    ...
    <title>::Navigand E-Commerce - Admin Dashboard</title>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            @if(Auth::guard('admin')->user()->profile_photo_path!=NULL)
                                Welcome  <img src="{{asset('storage/app/public/admin/'.Auth::guard('admin')->user()->id.'/'. Auth::guard('admin')->user()->profile_photo_path)}}" width="30" height="30" class="img-circle">
                            @else
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- Menu Footer-->
                            <li><h4>Welcome</h4></li>
                            <li><a href="/admin-change-picture"><span class="fa fa-user"></span>Edit Profile Picture</a></li>
                            <li><a href="/admin-change-password"><span class="fa fa-gear"></span>Change Password</a></li>
